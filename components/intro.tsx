    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://res.cloudinary.com/dpfbfliww/image/upload/v1730183082/IMG_5721_kyjtgy_bplp3n.png"
      ...
      >
        <span className="font-bold">Hello, I'm Tianhao.</span> I'm a{" "}
        ...
        as well as solving various real-world problems. 
      </motion.h1>
